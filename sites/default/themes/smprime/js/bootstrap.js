...
+function ($) { "use strict";
  ...
  $(document)
    ...
    .live('click.bs.dropdown.data-api', '.dropdown form', function (e) { e.stopPropagation() })
    .live('click.bs.dropdown.data-api'  , toggle, Dropdown.prototype.toggle)
    .live('keydown.bs.dropdown.data-api', toggle + ', [role=menu]' , Dropdown.prototype.keydown)
...
+function ($) { "use strict";
  ...
  $(document)
    .live('show.bs.modal',  '.modal', function () { $(document.body).addClass('modal-open') })
    .live('hidden.bs.modal', '.modal', function () { $(document.body).removeClass('modal-open') })
